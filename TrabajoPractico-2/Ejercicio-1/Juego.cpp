...
void Juego::menu()
{
	...
	sf::Text subtitleText(" El mejor Pong.", font, 12);
	...
	sf::String menuTextString[3] = { "Jugar", "Opciones", "Salir" };
	...
	sf::Text toolTip("Presiona ENTER para seleccionar", font, 12);
...
void Juego::over()
{
	sf::Text titleText("Puntaje final", font1, 72);
	titleText.setOrigin(std::round(titleText.getLocalBounds().width / 2), 20);
	titleText.setPosition((window.getSize().x / 2), 60);
	titleText.setFillColor(sf::Color(245, 147, 51));

	sf::Text scoreOverallText("Presiona ENTER para continuar", font, 12);
